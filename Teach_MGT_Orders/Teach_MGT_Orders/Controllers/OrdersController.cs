...
namespace Teach_MGT_Orders.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var mVCDbContext = _context.Order.Include(o => o.Customer);
        ...
        public async Task<IActionResult> Create([Bind("OrderId,Name,CustomerId")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,Name,CustomerId")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
